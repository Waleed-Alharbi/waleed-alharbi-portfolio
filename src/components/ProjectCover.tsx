...
export function ProjectCover({ project }: { project: PortfolioProject }) {
    ...
    return (
      <div className="project-cover helpdesk-cover">
        ...
        <motion.figure className="ui-window ui-window-main" whileHover={windowMotion} transition={{ duration: .4 }}>
          <WindowBar label="OPERATIONS OVERVIEW" /><img src={images[0].src} alt={images[0].alt[language]} loading="lazy" decoding="async" />
        </motion.figure>
        <motion.figure className="ui-window ui-window-secondary" whileHover={windowMotion} transition={{ duration: .4 }}>
          <WindowBar label="TICKET QUEUE" /><img src={images[1].src} alt={images[1].alt[language]} loading="lazy" decoding="async" />
        </motion.figure>
  ...
  if (project.theme === 'soc') {
    return (
      <div className="project-cover soc-cover">
        ...
        <motion.figure className="soc-screen soc-screen-main" whileHover={windowMotion}><img src={images[0].src} alt={images[0].alt[language]} loading="lazy" decoding="async" /></motion.figure>
        <motion.figure className="soc-screen soc-screen-network" whileHover={windowMotion}><img src={images[1].src} alt={images[1].alt[language]} loading="lazy" decoding="async" /></motion.figure>
  ...
  if (project.theme === 'waqttech') {
    return (
      <div className="project-cover waqt-cover">
        ...
        <motion.figure className="waqt-screen waqt-screen-main" whileHover={windowMotion}><img src={images[0].src} alt={images[0].alt[language]} loading="lazy" decoding="async" /></motion.figure>
        <motion.figure className="waqt-screen waqt-screen-phone" whileHover={reduceMotion ? undefined : { y: -12, rotate: -1 }}><img src={images[2].src} alt={images[2].alt[language]} loading="lazy" decoding="async" /></motion.figure>
  ...
  if (project.theme === 'basira') {
    return (
      <div className="project-cover basira-cover">
        ...
        <motion.figure className="basira-screen basira-screen-main" whileHover={windowMotion}><img src={images[0].src} alt={images[0].alt[language]} loading="lazy" decoding="async" /></motion.figure>
        <motion.figure className="basira-screen basira-screen-model" whileHover={windowMotion}><img src={images[2].src} alt={images[2].alt[language]} loading="lazy" decoding="async" /></motion.figure>
  ...
  return (
    <div className="project-cover bunya-cover">
      ...
      <motion.figure className="bunya-screen bunya-screen-main" whileHover={windowMotion}><img src={images[0].src} alt={images[0].alt[language]} loading="lazy" decoding="async" /></motion.figure>
      <motion.figure className="bunya-screen bunya-screen-trace" whileHover={windowMotion}><img src={images[2].src} alt={images[2].alt[language]} loading="lazy" decoding="async" /></motion.figure>
